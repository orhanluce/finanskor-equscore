...
export const COUNTRIES = {
  SA: {
    ...
    modules: {
      ...
      currencyRisk: false, inflationAdj: false, dualBoard: false,
  ...
  AE: {
    ...
    modules: {
      ...
      currencyRisk: false, inflationAdj: false, dualBoard: true,
  ...
  EG: {
    ...
    modules: {
      ...
      momentum: false, contrarian: true, ipoFocus: true, dividendFocus: true,
      currencyRisk: true, inflationAdj: true, dualBoard: false,
